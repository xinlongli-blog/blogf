...
![image-20250728172618429](./img/thread3.jpg)
...
...
(gdb) thread 3
[Switching to thread 3 (Thread 0x7f898c11f700 (LWP 20734))]
#0  0x00007f89ab85ede2 in pthread_cond_timedwait@@GLIBC_2.3.2 () from /lib64/libpthread.so.0
(gdb) bt
#0  0x00007f89ab85ede2 in pthread_cond_timedwait@@GLIBC_2.3.2 () from /lib64/libpthread.so.0
#1  0x0000000001877275 in native_cond_timedwait (cond=0x7f894c000cc8, mutex=0x7f894c000c80, abstime=0x7f898c11b030) at /data/debugdb/mysql-5.7.27/include/thr_cond.h:129
#2  0x00000000018775da in safe_cond_timedwait (cond=0x7f894c000cc8, mp=0x7f894c000c58, abstime=0x7f898c11b030, file=0x1f47970 "/data/debugdb/mysql-5.7.27/sql/mdl.cc", line=1861)
    at /data/debugdb/mysql-5.7.27/mysys/thr_cond.c:88
#3  0x0000000001438d86 in my_cond_timedwait (cond=0x7f894c000cc8, mp=0x7f894c000c58, abstime=0x7f898c11b030, file=0x1f47970 "/data/debugdb/mysql-5.7.27/sql/mdl.cc", line=1861)
    at /data/debugdb/mysql-5.7.27/include/thr_cond.h:180
#4  0x00000000014392ad in inline_mysql_cond_timedwait (that=0x7f894c000cc8, mutex=0x7f894c000c58, abstime=0x7f898c11b030, src_file=0x1f47970 "/data/debugdb/mysql-5.7.27/sql/mdl.cc", 
    src_line=1861) at /data/debugdb/mysql-5.7.27/include/mysql/psi/mysql_thread.h:1229
#5  0x000000000143a3d9 in MDL_wait::timed_wait (this=0x7f894c000c58, owner=0x7f894c000bc0, abs_timeout=0x7f898c11b030, set_status_on_timeout=false, 
    wait_state_name=0x2c70de8 <MDL_key::m_namespace_to_wait_state_name+72>) at /data/debugdb/mysql-5.7.27/sql/mdl.cc:1861
#6  0x000000000143c1f4 in MDL_context::acquire_lock (this=0x7f894c000c58, mdl_request=0x7f898c11b0d0, lock_wait_timeout=31536000) at /data/debugdb/mysql-5.7.27/sql/mdl.cc:3655
#7  0x000000000143c951 in MDL_context::upgrade_shared_lock (this=0x7f894c000c58, mdl_ticket=0x7f894c00e7a0, new_type=MDL_EXCLUSIVE, lock_wait_timeout=31536000)
    at /data/debugdb/mysql-5.7.27/sql/mdl.cc:3919
#8  0x00000000015cd51d in mysql_inplace_alter_table (thd=0x7f894c000bc0, table_list=0x7f894c0062b8, table=0x7f894c00ef20, altered_table=0x7f894c0112c0, ha_alter_info=0x7f898c11bb90, 
    inplace_supported=HA_ALTER_INPLACE_NO_LOCK_AFTER_PREPARE, target_mdl_request=0x7f898c11b5d0, alter_ctx=0x7f898c11c120) at /data/debugdb/mysql-5.7.27/sql/sql_table.cc:7451
#9  0x00000000015d2adc in mysql_alter_table (thd=0x7f894c000bc0, new_db=0x7f894c006840 "test_db", new_name=0x0, create_info=0x7f898c11cdc0, table_list=0x7f894c0062b8, 
    alter_info=0x7f898c11cd10) at /data/debugdb/mysql-5.7.27/sql/sql_table.cc:9800
#10 0x000000000174b8af in Sql_cmd_alter_table::execute (this=0x7f894c006930, thd=0x7f894c000bc0) at /data/debugdb/mysql-5.7.27/sql/sql_alter.cc:327
#11 0x0000000001540ea0 in mysql_execute_command (thd=0x7f894c000bc0, first_level=true) at /data/debugdb/mysql-5.7.27/sql/sql_parse.cc:4835
#12 0x0000000001542c49 in mysql_parse (thd=0x7f894c000bc0, parser_state=0x7f898c11e690) at /data/debugdb/mysql-5.7.27/sql/sql_parse.cc:5570
#13 0x00000000015386d8 in dispatch_command (thd=0x7f894c000bc0, com_data=0x7f898c11edf0, command=COM_QUERY) at /data/debugdb/mysql-5.7.27/sql/sql_parse.cc:1484
#14 0x000000000153760c in do_command (thd=0x7f894c000bc0) at /data/debugdb/mysql-5.7.27/sql/sql_parse.cc:1025
#15 0x0000000001667f0c in handle_connection (arg=0x47ab2e0) at /data/debugdb/mysql-5.7.27/sql/conn_handler/connection_handler_per_thread.cc:306
#16 0x0000000001cf3066 in pfs_spawn_thread (arg=0x3c78460) at /data/debugdb/mysql-5.7.27/storage/perfschema/pfs.cc:2190
#17 0x00007f89ab85aea5 in start_thread () from /lib64/libpthread.so.0
#18 0x00007f89aa51eb0d in clone () from /lib64/libc.so.6
(gdb) f 6 
# 跳转到  MDL_context::acquire_lock
#acquire_lock 函数参数中有 MDL_request
# MDL_request::MDL_key 中有详细的锁信息
#6  0x000000000143c1f4 in MDL_context::acquire_lock (this=0x7f894c000c58, mdl_request=0x7f898c11b0d0, lock_wait_timeout=31536000) at /data/debugdb/mysql-5.7.27/sql/mdl.cc:3655
3655                                         mdl_request->key.get_wait_state_name());
(gdb) p mdl_request->key
$1 = {m_length = 18, m_db_name_length = 7, 
  m_ptr = "\003test_db\000mdl_demo\000\000\000Z\211\216\001\000\000\000\000\355\005\000\000\000\000\000\000\310 !\002\000\000\000\000\bMݠ\211\177\000\000 Mݠ\211\177\000\000`\261\021\214\211\177\000\000\352}\231\001\000\000\000\000\000\367\021\214\211\177\000\000\000\367\021\214\211\177\000\000p\261\021\214\211\177\000\000\000\000\000\000\000\000\000\000\bMݠ\211\177\000\000\060Mݠ\211\177\000\000\001\000\000\000\000\000\000\000\220\261\021\214\211\177\000\000߉\216\001\000\000\000\000\bMݠ\211\177\000\000\260\261\021\214\211\177\000\000\274j\216\001\000\000\000\000\bMݠ\211\177\000\000\bMݠ\211\177\000\000\340\261\021\214\211\177\000\000\326F\216\001\000\000\000\000\024\000\000\000\000\000\000\000"..., 
  static m_namespace_to_wait_state_name = {{m_key = 111, m_name = 0x1f477e6 "Waiting for global read lock", m_flags = 0}, {m_key = 112, 
      m_name = 0x1f47808 "Waiting for tablespace metadata lock", m_flags = 0}, {m_key = 113, m_name = 0x1f47830 "Waiting for schema metadata lock", m_flags = 0}, {m_key = 114, 
      m_name = 0x1f47858 "Waiting for table metadata lock", m_flags = 0}, {m_key = 115, m_name = 0x1f47878 "Waiting for stored function metadata lock", m_flags = 0}, {m_key = 116, 
      m_name = 0x1f478a8 "Waiting for stored procedure metadata lock", m_flags = 0}, {m_key = 117, m_name = 0x1f478d8 "Waiting for trigger metadata lock", m_flags = 0}, {m_key = 118, 
      m_name = 0x1f47900 "Waiting for event metadata lock", m_flags = 0}, {m_key = 119, m_name = 0x1f47920 "Waiting for commit lock", m_flags = 0}, {m_key = 120, 
